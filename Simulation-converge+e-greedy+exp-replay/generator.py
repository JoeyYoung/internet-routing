...
class Generator:
    ...
    def build_topology(self):
        ...
        # count = 0
        # for i in self.Cs:
        #     if len(i.providers_T) > 0 and len(i.providers_M) > 0:
        #         for j in i.providers_T:
        #             for k in i.providers_M:
        #                 if k in j.customers_M:
        #                     count += 1
...
# # # #
# i = g.CPs[2]
# for j in i.table.keys():
#     print("=============")
#     print("to " + str(j) + " : ")
#     for path in i.table[j]:
#         print("----------")
#         for e in path:
#             print(e.id)
# for j in i.table_peer.keys():
#     print("=============")
#     print("to " + str(j) + " : ")
#     for path in i.table_peer[j]:
#         print("----------")
#         for e in path:
#             print(e.id)
# for j in i.table_provider.keys():
#     print("=============")
#     print("to " + str(j) + " : ")
#     for path in i.table_provider[j]:
#         print("----------")
#         for e in path:
#             print(e.id)
...
# print("========= CHECK LINK ===========")
# for i in g.Ts:
#     for j in i.customers_M:
#         if i not in j.providers_T:
#             print("fuck")
#     for j in i.customers_C:
#         if i not in j.providers_T:
#             print("fuck")
#     for j in i.peers_T:
#         if i not in j.peers_T:
#             print("fuck")
#
# for i in g.Ms:
#     for j in i.customers_C:
#         if i not in j.providers_M:
#             print("fuck")
#
# print("========= CHECK DONE ===========")
...
# for i in g.Ms:
#     if len(i.table_peer) > 0:
#         print(i.id)
# for i in g.Cs:
#     if len(i.table_peer) > 0:
#         print(i.id)
# # print(g.Cs[1].action_labels)

# print(g.Cs[2].action_labels)
