...
class Game:
    def __init__(self):
        ...
        self.RLs = self.generator.Ts + self.generator.Ms[:2]
        self.N = 92
...
if __name__ == '__main__':
    with tf.device('/cpu:0'):
        ...
        BaseManager.register('get_actions_glb_g3_queue')
        ...
        actions_glb_g3 = mgr.get_actions_glb_g3_queue()
