...
class Game:
    def __init__(self):
        ...
        self.RLs = self.generator.Ms[2:8]
        self.N = 92
...
if __name__ == '__main__':
    with tf.device('/cpu:0'):
        ...
        BaseManager.register('get_actions_g4_queue')
        BaseManager.register('get_rewards_g4_queue')
        BaseManager.register('get_states_g4_queue')
        BaseManager.register('get_fap_g4_queue')
        BaseManager.register('get_finish_g4_queue')
        BaseManager.register('get_actions_glb_g4_queue')
        mgr = BaseManager(address=("172.16.68.1", 4444), authkey=b"game")

        mgr.connect()
        actions_g4 = mgr.get_actions_g4_queue()
        rewards_g4 = mgr.get_rewards_g4_queue()
        states_g4 = mgr.get_states_g4_queue()
        fap_g4 = mgr.get_states_g4_queue()
        finish_g4 = mgr.get_finish_g4_queue()
        actions_glb_g4 = mgr.get_actions_glb_g4_queue()
        ...
        for time_round in range(game.MAX):
            ...
            """
            actions_g4.put(memory['actions'])

            s = states_g4.get()
            r = rewards_g4.get()
            fap = fap_g4.get()
            g_a = actions_glb_g4.get()
