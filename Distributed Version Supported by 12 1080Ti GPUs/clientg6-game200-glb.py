...
if __name__ == '__main__':
    with tf.device('/cpu:0'):
        ...
        BaseManager.register('get_actions_g6_queue')
        BaseManager.register('get_rewards_g6_queue')
        BaseManager.register('get_states_g6_queue')
        BaseManager.register('get_fap_g6_queue')
        BaseManager.register('get_finish_g6_queue')
        BaseManager.register('get_actions_glb_g6_queue')
        mgr = BaseManager(address=("172.16.68.1", 4444), authkey=b"game")

        mgr.connect()
        actions_g6 = mgr.get_actions_g6_queue()
        rewards_g6 = mgr.get_rewards_g6_queue()
        states_g6 = mgr.get_states_g6_queue()
        fap_g6 = mgr.get_states_g6_queue()
        finish_g6 = mgr.get_finish_g6_queue()
        actions_glb_g6 = mgr.get_actions_glb_g6_queue()
        ...
        for time_round in range(game.MAX):
            ...
            """
            actions_g6.put(memory['actions'])

            s = states_g6.get()
            r = rewards_g6.get()
            fap = fap_g6.get()
            g_a = actions_glb_g6.get()
